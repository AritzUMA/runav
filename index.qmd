...
<div class="hero-banner">
  <p class="subtitulo">Taller intensivo · Universidad de Navarra</p>
  <h1>Introducción a R<br>para <em>Lingüistas</em></h1>
  <p class="gradun">GRADUN — Grupo de Análisis del Discurso</p>
  <div class="meta-grid">
    <div class="meta-item">
      <span class="etiqueta">Nivel</span>
      <span class="valor">Introductorio, sin conocimientos previos</span>
    </div>
    <div class="meta-item">
      <span class="etiqueta">Duración</span>
      <span class="valor">4 bloques de 30 minutos</span>
    </div>
    <div class="meta-item">
      <span class="etiqueta">Paquetes</span>
      <span class="valor">tidyverse · tidytext · syuzhet · quanteda · udpipe</span>
    </div>
  </div>
</div>
```
