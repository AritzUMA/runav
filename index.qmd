...
Para saber qué tipo de gráfico usar según tus datos, la [**R Graph Gallery**](https://r-graph-gallery.com/ggplot2-package.html) es el recurso más completo disponible. Organiza todos los tipos de gráficos de `ggplot2` por categoría y tipo de variable, e incluye el código completo para cada uno.
